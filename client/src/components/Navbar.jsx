...
const Navbar = () => {
    ...
    return (
        <div className="bg-zinc-800 border-b-2 px-2 py-1 border-zinc-700">
            ...
            <div className="flex border-b-2 border-zinc-700 flex-row items-start sm:px-5 w-full h-fit py-2 xl:px-60 md:px-10 justify-between">
                <div className="flex gap-4 flex-row mr-12">
                    <span className=' cursor-pointer whitespace-nowrap   white text-sm'>24hr Volume : <span className='text-blue-500'>$398,980,987 <span className='text-green-400'>+23%</span></span></span>
                    <span className=' cursor-pointer  whitespace-nowrap white  text-sm'>24hr Liquidation : <span className='text-blue-500'>$398,980,987 <span className='text-green-400'>+23%</span></span></span>
                    <span className=' cursor-pointer whitespace-nowrap  white  text-sm'>24hr Long/Short : <span className='text-blue-400'>41% / </span> <span className='text-blue-400'>59%</span></span>
                    <span className=' cursor-pointer  whitespace-nowrap white  text-sm'>Open Interest : <span className='text-blue-500'>$398,980,987 <span className='text-green-400'>+23%</span></span></span>
                </div>
